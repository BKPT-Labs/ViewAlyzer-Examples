#!/usr/bin/env python3
"""Build and flash helper for Nucleo_C031_VA.
...
switching never hits a stale CMake cache):
    rambuf   RAM ring drained through the on-board ST-LINK (the only transport
             this Cortex-M0+ part supports without a J-Link: no ITM/SWO)
...
PROJECT = "Nucleo_C031_VA"
ELF_NAME = "Nucleo_C031_VA"
PROBE = "stlink"                      # "stlink" or "jlink"
TARGET_DEVICE = "STM32C031C6"      # device name for J-Link flashing
TRANSPORTS = {"rambuf": None}              # cli name -> VA_TRANSPORT value (None = project default)
