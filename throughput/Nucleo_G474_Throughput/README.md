# Nucleo-G474RE - Transport Throughput Benchmark

Bare-metal (no RTOS) benchmark that measures **how many trace bytes per second
a ViewAlyzer transport can actually sustain** from a Nucleo-G474RE
(STM32G474RE, Cortex-M4F @ 170 MHz) to the host, over the board's on-board
...
# SWO / ITM
ViewAlyzer --headless --config nucleo_g474_swo.vacf \
