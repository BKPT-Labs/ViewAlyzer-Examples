...
> For STLink ITM or J-Link RTT transport from embedded firmware, use the recorder in `ViewAlyzerRecorder/` (repo root) instead.
...
- `desktop_example` - ready-to-run x86 example (core only)
- `desktop_example_cpp` - C++ example with a pluggable transport
...
```cmake
add_subdirectory(path/to/ViewAlyzer-Examples/Desktop-CPP-UDP/c-udp)
...
Copyright 2025-2026 BKPT, Inc. Licensed under the Apache License 2.0; see [LICENSE](../../../LICENSE).
