...
and the recording's **Overview → Trace Summary** shows **Avg / Peak
Throughput** under *Stream Integrity*.
...
- This project is a *benchmark*, not a usage example - it deliberately floods
  the transport. For a normal integration reference see
  [`baremetal/Nucleo_H723_VA`](../../baremetal/Nucleo_H723_VA/).
