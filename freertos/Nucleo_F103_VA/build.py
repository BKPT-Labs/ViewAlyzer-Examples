#!/usr/bin/env python3
"""Build and flash helper for Nucleo_F103_VA.
...
This project has a single (fixed) transport configuration; the build goes
into build/default/.
...
PROJECT = "Nucleo_F103_VA"
ELF_NAME = "Nucleo_F103_VA"
PROBE = "stlink"                      # "stlink" or "jlink"
TARGET_DEVICE = "STM32F103RB"      # device name for J-Link flashing
TRANSPORTS = {"default": None}              # cli name -> VA_TRANSPORT value (None = project default)
