#pragma once
/* ViewAlyzer recorder configuration for the Nucleo-C031C6 (Cortex-M0+).
...
/* 12 KB of SRAM on this part: a 4 KB ring leaves room for the stack and the
 * recorder's own state. */
#define VA_RAMBUF_SIZE      4096u
